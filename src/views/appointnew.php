  ...
  <form action="?page=submit_appointment" method="POST">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="flex flex-col justify-center p-4 gap-4">
        <label for="pet_id" class="text-gray-600 font-semibold tracking-wide italic">Choose Pet</label>
        <select name="pet_id" id="pet_id" required class="h-10 border border-black p-2 bg-white text-black outline-0 hover:border-teal-400 hover:shadow-lg transition-all duration-300 ease-in-out rounded-md shadow-md focus:border-emerald-400 focus:border-2 focus:shadow-lg">
      ...
      <div class="flex flex-col justify-center p-4 gap-4">
        <label for="appointment_time" class="text-gray-600 font-semibold tracking-wide italic">Appointment Date & Time</label>
        <input type="datetime-local" name="appointment_time" id="appointment_time" required class="h-10 border border-black p-2 text-black outline-0 hover:border-teal-400 hover:shadow-lg transition-all duration-300 ease-in-out rounded-md shadow-md focus:border-emerald-400 focus:border-2 focus:shadow-lg" />
      </div>
